...
const Navbar = () => {
  ...
  <Link
    className={`hover:text-sky-600 ${
      isActiveMenuItem("/") ? "underline ml-2 mr-2" : ""
    }`}
    href="/"
  >
    Home
  ...
  <Link
    className={`hover:text-sky-600 ${
      isActiveMenuItem("/about") ? "underline ml-2 mr-2" : ""
    }`}
    href="/about"
  >
    About
  ...
  <Link
    className={`hover:text-sky-600 ${
      isActiveMenuItem("/services") ? "underline ml-2 mr-2" : ""
    }`}
    href="/services"
  >
    Services
  ...
  <Link
    className={`hover:text-sky-600 ${
      isActiveMenuItem("/photo-gallery") ? "underline ml-2 mr-2" : ""
    }`}
    href="/photo-gallery"
  >
    Gallery
                ...
                >
                  <SlMenu className="h-6 w-6 absolute right-10 text-blue-100" />
                </button>
              )}
            </div>
          </div>
